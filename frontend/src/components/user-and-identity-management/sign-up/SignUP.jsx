...
const SignUP = () => {
	...
	const [form, setForm] = useState({ fullName: '', email: '', role: '', password: '', confirm: '' });
	...
	const handleSubmit = (e) => {
		...
		console.log('Sign up successful for:', form);

		// Route the user to their specific profile page based on their role
		switch (form.role) {
			case 'campsite owner':
