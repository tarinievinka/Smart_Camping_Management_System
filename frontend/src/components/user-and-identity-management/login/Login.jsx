					...
					<form onSubmit={handleSubmit} className="space-y-4">
						...
						<div>
							<div className="flex justify-between items-center mb-1">
								...
								<button type="button" onClick={() => navigate('/forgot')} className="text-[11px] text-[#10a110] font-bold hover:underline">Forgot password?</button>
							</div>
							<div className="relative">
								<span className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400">
									<svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
						...
						<button type="submit" className="w-full mt-6 bg-[#10a110] hover:bg-green-700 text-white font-bold py-3.5 rounded-xl text-sm flex items-center justify-center gap-2 transition-all duration-300 shadow-[0_0_15px_rgba(16,161,16,0.3)] hover:shadow-[0_0_20px_rgba(16,161,16,0.5)] transform hover:-translate-y-0.5">
							Sign In
